% Simulation d'un bloc d'essais sournote1 ou sournote4 avec échelle diatonique
...
% 1) exposant==2
% sigma==0.50    d'==0.86    critère (c)==-1.31    
% sigma==0.30    d'==2.19    critère (c)==-0.74
% 2) exposant==1
% Exactement pareil que pour exposant==2  


rng('shuffle'); % initialisation générateur nbs aléatoires    
D = [0 2 4 5 7 9 11 12]; % échelle diatonique, mode majeur
Nnotes = size(D, 2);
% Liste des échelles avec une fausse note comme dans sournote4
E1 = [0 1 4 5 7 9 11 12];
E2 = [0 3 4 5 7 9 11 12]; 
E3 = [0 2 3 5 7 9 11 12]; 
E4 = [0 2 4 6 7 9 11 12]; 
E5 = [0 2 4 5 6 9 11 12]; 
E6 = [0 2 4 5 8 9 11 12]; 
E7 = [0 2 4 5 7 8 11 12]; 
E8 = [0 2 4 5 7 10 11 12]; 
E9 = [0 2 4 5 7 9 10 12]; 
...
for essai = 1:total_essais
    ...
    %
    %
    % On compare T à D ainsi qu'à E1, E2, ... E9.
    % Si D est l'échelle qui ressemble le plus à T, on répond Normal (S==D), sinon on répond Anormal
    TD=0; TE1=0; TE2=0; TE3=0; TE4=0; TE5=0; TE6=0; TE7=0; TE8=0; TE9=0; % initialisations
    for i = 2 : Nnotes-1
    ...
    TEmin = min([TE1, TE2, TE3, TE4, TE5, TE6, TE7, TE8, TE9]);
